$(function () {
	...
	// Use ZeroClipboard to copy the hex code to clipboard on button click
	...
	client.on('aftercopy', function() {
			var confirmedMessage = document.getElementById('confirm');
			$(confirmedMessage).fadeIn(500).fadeOut(500);
	});
